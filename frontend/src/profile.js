...
class Profile extends Component {
    ...
    componentDidMount() {
        ...
        this.props.client.query({
            ...
            console.log("response ka data "+JSON.stringify(res.data));
            if (res.data.userbyid.error) {
                alert("user not found")
            }
            else {
                this.setState({
                    firstname: this.state.firstname.concat(res.data.userbyid.firstname),
                    lastname: this.state.lastname.concat(res.data.userbyid.lastname),
                    about: this.state.about.concat(res.data.userbyid.about),
                    gender: this.state.gender.concat(res.data.userbyid.gender),
                    phone: this.state.phone.concat(res.data.userbyid.phone),
                    company: this.state.company.concat(res.data.userbyid.company),
                    languages: this.state.languages.concat(res.data.userbyid.languages),
                    location: this.state.location.concat(res.data.userbyid.location)
                })
...
handleSubmit = e => {
    ...
    // };
    const result = this.props.updateUserMutation({
        variables: {
            firstname: this.state.firstname,
            lastname: this.state.lastname,
...
export default compose(withApollo,
    ...
    graphql(updateUserMutation, { name: "updateUserMutation" }))(Profile);
